...
function BottomNav2() {
    ...
    return (
        ...
        <div>
       <Link to='/' style={{ textDecoration: 'none' }}> <p><span className='laptop5'><FaAngleLeft /></span><span className='client1'>Reselect Technologies</span></p></Link>
        </div></Paper>
      ...
      <Grid item xl={6} lg={6} md={6} sm={6} xs={6} >
        <Paper className={classes.clientside} elevation={0}>
        <div id='rightfloat'>
       <Link to='Pagetwo'style={{ textDecoration: 'none' }} > <p><span className='client1'>How can you track progress</span><span className='laptop5'><FaAngleRight /></span></p></Link>
        </div></Paper>
